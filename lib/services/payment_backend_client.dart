...
class PaymentBackendClient {
  ...
  /// Resolves a therapist withdrawal request as an admin.
  /// [status] must be either 'paid' or 'rejected'.
  /// [adminNotes] is optional but recommended (reference ID for paid, reason for rejected).
