...
class _ClothesScreenState extends State<ClothesScreen> {
  ...
  final List<ClothesItem> clothes = [
    ClothesItem(name: 'T-shirts', emoji: '👕'),
    ClothesItem(name: 'Sweater', emoji: '🧥'),
    ClothesItem(name: 'Shorts', emoji: '🩳'),
    ClothesItem(name: 'Dress', emoji: '👗'),
  ];
  ...
  Future<void> _speakClothes(String name) async {
...
class ClothesItem {
  final String name;
  final String emoji;
  ClothesItem({required this.name, required this.emoji});
}
