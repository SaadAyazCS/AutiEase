          ...
          child: ListView(
            ...
            children: [
              _NotificationRow(
                ...
                subtitle: 'When therapists send you chat messages',
                value: _preferences['therapistsUpdate'] ?? false,
                onToggle: () => _toggle('therapistsUpdate'),
              ),
              _NotificationRow(
                title: 'Game & Activity Completions',
                subtitle: 'When your child completes games or daily activities',
              ...
              _NotificationRow(
                ...
                subtitle: 'Receive alerts for payments, renewals, and cancellations',
                value: _preferences['subscription'] ?? false,
                onToggle: () => _toggle('subscription'),
              ),
              _NotificationRow(
                title: 'Routine & Schedule Updates',
                subtitle: 'Get notified when routines or schedules are updated',
