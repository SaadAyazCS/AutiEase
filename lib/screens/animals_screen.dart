...
class _AnimalsScreenState extends State<AnimalsScreen> {
  ...
  final List<AnimalItem> animals = [
    AnimalItem(name: 'Elephant', emoji: '🐘'),
    AnimalItem(name: 'Giraffe', emoji: '🦒'),
    AnimalItem(name: 'Monkey', emoji: '🐒'),
    AnimalItem(name: 'Tiger', emoji: '🐅'),
    AnimalItem(name: 'Bear', emoji: '🐻'),
    AnimalItem(name: 'Duck', emoji: '🦆'),
  ];
  ...
  Widget _buildAnimalCard(AnimalItem item) {
...
class AnimalItem {
  final String name;
  final String emoji;
  AnimalItem({required this.name, required this.emoji});
}
